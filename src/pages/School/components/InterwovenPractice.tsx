                        ...
                        <div className="col-xl-6">
                          ...
                          >
                            ...
                            >
                              ...
                              <img
                                decoding="async"
                                src="/images/PracticesAndCoursesImg.png"
                                alt="alt"
                                title="about-1-1"
                              />
                            </div>
                        ...
                        <div className="col-xl-6">
                          <div className="about-one__content">
                            ...
                            <p
                              ...
                              style={{ width: "80%" }}
                            >
                              Your students can effortlessly transition from
                              practice sessions to related courses and vice
                              versa. This interconnected approach ensures a
                              fluid educational journey, allowing students to
                              reinforce their understanding by navigating
                              between relevant courses and related practice
                              questions with ease
                            </p>
                            <a
                              href={`${consoleUrl}`}
