...
import { ExamPlatformItem, examPlatformData } from "./components";
                  ...
                  >
                    <div className="container">
                      <div className="section-title text-center">
                        ...
                        >
                          Diverse question banks are made available and schools
                          can bring theirs online for students to practice
                        </h2>
                      </div>
                      {/* <!-- section-title --> */}
                      <div
