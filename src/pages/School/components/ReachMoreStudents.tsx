                        ...
                        <div className="col-xl-6">
                          ...
                          >
                            ...
                            >
                              ...
                              <img
                                decoding="async"
                                src="/images/ReachMoreStudentImg.png"
                                alt="alt"
                                title="about-1-1"
                              />
                            </div>
                        ...
                        <div className="col-xl-6">
                          <div className="about-one__content">
                            ...
                            <p
                              ...
                              style={{ width: "80%" }}
                            >
                              You can set your school up privately and only
                              invite student to a cohort with emailed access or
                              you can publish your courses publicly and allow
                              learners to pay and register to join a cohort in
                              the specific course
                            </p>
                            <a
                              href={`${consoleUrl}`}
...
export default ReachMoreStudents;
