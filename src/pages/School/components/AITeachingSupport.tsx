                        ...
                        <div className="col-xl-6">
                          ...
                          >
                            ...
                            >
                              ...
                              <img
                                decoding="async"
                                src="/images/AITeachingSupportImg.png"
                                alt="alt"
                                title="about-1-1"
                              />
                            </div>
                        ...
                        <div className="col-xl-6">
                          <div className="about-one__content">
                            ...
                            <p
                              ...
                              style={{ width: "80%" }}
                            >
                              Using prepcohort gives you the option to leverage
                              AI Assistance every step of managing your student
                              learning process. From knowledge testing, creating
                              lessons, grading and even in reports,
                              recommendation etc, AI is plugged in as an
                              optional assistant to be leverage at will to make
                              you far more accurate , efficient and more
