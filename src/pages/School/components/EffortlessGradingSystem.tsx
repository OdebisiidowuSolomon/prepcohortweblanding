                        ...
                        <div className="col-xl-6">
                          ...
                          >
                            ...
                            >
                              ...
                              <img
                                decoding="async"
                                src="/images/EffortlessGradingSystemImg.png"
                                alt="alt"
                                title="about-1-1"
                              />
                            </div>
                        ...
                        <div className="col-xl-6">
                          <div className="about-one__content">
                            ...
                            <p
                              ...
                              style={{ width: "80%" }}
                            >
                              Grading and feedback have never been easier and
                              better integrated. You can use auto-grading,
                              rubric, standard grading or any combination of the
                              3 in our platform while feedback can be done
                              individually or addressed to people with similar
...
export default EffortlessGradingSystem;
