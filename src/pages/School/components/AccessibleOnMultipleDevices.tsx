...
function AccessibleOnMultipleDevices() {
  return (
    <>
      <section
                        ...
                        <div className="col-xl-6">
                          <div className="about-one__content">
                            ...
                            <p
                              ...
                              style={{ width: "80%" }}
                            >
                              Enable your students to access your courses
                              effortlessly across multiple devices with
                              Prepcohort. Whether they prefer learning on big or
                              small screens, our platform ensures a consistent,
                              user-friendly experience, flexible and convenient
                              learning experience
                            </p>
                            <a
...
export default AccessibleOnMultipleDevices;
