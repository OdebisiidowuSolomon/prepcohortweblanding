                        ...
                        <div className="col-xl-6">
                          ...
                          >
                            ...
                            >
                              ...
                              <img
                                decoding="async"
                                src="/images/FacilitatedTeachingImg.png"
                                alt="alt"
                                title="about-1-1"
                              />
                            </div>
                        ...
                        <div className="col-xl-6">
                          <div className="about-one__content">
                            ...
                            <p
                              ...
                              style={{ width: "80%" }}
                            >
                              From interactive lessons to clear communication
                              channels, our features are crafted to enhance your
                              school’s teaching methods, making teachers deliver
                              their contents better and as well optimizing
