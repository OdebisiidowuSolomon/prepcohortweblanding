                        ...
                        <div className="col-xl-6">
                          ...
                          >
                            ...
                            >
                              ...
                              <img
                                decoding="async"
                                src="/images/StaffAppointmentImg.png"
                                alt="alt"
                                title="about-1-1"
                              />
                            </div>
                        ...
                        <div className="col-xl-6">
                          <div className="about-one__content">
                            ...
                            <p
                              ...
                              style={{ width: "80%" }}
                            >
                              Schools can efficiently manage staff roles and
                              appointments on Prepcohort, empowering
                              administrators to assign specific roles to
                              educators and other staff members. This feature
                              streamlines responsibilities, ensuring a
                            ...
                            >
                              <span className="eduact-btn__curve"></span>Start Learning
                              Now
                            </a>
                          </div>
                          {/* <!-- about content end--> */}
