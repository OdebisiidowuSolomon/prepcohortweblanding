...
function WhyStudyWithUs() {
  return (
    <>
      <section
        className="elementor-section elementor-top-section elementor-element elementor-element-7ac9e656 elementor-section-full_width elementor-section-height-default elementor-section-height-default"
        data-id="7ac9e656"
        data-element_type="section"
      >
        <div className="elementor-container elementor-column-gap-no">
          <div
            className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-71a988c1"
            data-id="71a988c1"
            data-element_type="column"
          >
            <div className="elementor-widget-wrap elementor-element-populated">
              <div
                className="elementor-element elementor-element-68a12e2c elementor-widget elementor-widget-eduact-testimonials"
                data-id="68a12e2c"
          ...
          "navText": ["<span class=\"icon-arrow-left\"></span>","<span class=\"icon-arrow\"></span>"]
                          ...
                          <div className="item">
                            <div className="testimonial-one__item">
                              ...
                              <div className="testimonial-one__content">
                                ...
                                >
                                  Our instructor-led approach ensures a
                                  supportive and interactive learning
                                  environment for a more enriching educational
                                  experience. Engage directly with qualified
                                  educators from different schools who will
                                  guide you through material, answer questions,
                            ...
                            <div className="testimonial-one__item">
                              ...
                              <div className="testimonial-one__content">
                                ...
                                <div
                                  ...
                                  style={{ marginBottom: "2rem" }}
                                >
                                  With Prepcohort offline support an unstable
                                  internet will not affect timed quizzes,
                                  prevent studying, practising of question bank
                                  etc. We make sure this doesn't happen by
                                  allowing resources like course materials,
                                  practice questions, quizzes etc downloadable
                            ...
                            <div className="testimonial-one__item">
                              ...
                              <div className="testimonial-one__content">
                                ...
                                <div
                                  ...
                                  style={{ marginBottom: "2rem" }}
                                >
                                  Enjoy the flexibility of wide range of devices
                                  support on prepcohort which allow your student
                                  to join class and do their tasks with smart
                                  phones, tablets and PC through our mobile app
                                  and responsive web app.
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        >
                          ...
                          >
                            <img
                              decoding="async"
                              src="/images/testimonial-shape-1.png"
