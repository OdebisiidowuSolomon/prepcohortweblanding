                  ...
                  >
                    <div className="container">
                      <div className="section-title text-center">
                        ...
                        >
                          Our platform is designed to replicate the exam
                          environment. Practice with simulated exams to prepare
                        ...
                        <div className="item">
                          <div className="category-one__item">
                            <div
                              ...
                              style={{
                                backgroundImage:
                                  "url(images/category-shape.png)",
                              }}
                            >
                              <div className="category-one__thumb">
                                <img
                                  decoding="async"
                                  src="/images/category-normal-1.png"
                              ...
                              <div className="category-one__content">
                                ...
                                {/* <!-- /.category-icon --> */}
                                <h3 className="category-one__title">SAT</h3>
                                {/* <!-- /.category-title --> */}
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="category-one__item">
                            ...
                            >
                              <div className="category-one__thumb">
                                <img
                                  decoding="async"
                                  src="/images/category-normal-2.png"
                                  alt="category-normal-2"
                                  title="category-normal-2"
                                />
                              </div>
                              {/* <!-- /.category-thumb --> */}
                              <div className="category-one__content">
                                ...
                                {/* <!-- /.category-icon --> */}
                                <h3 className="category-one__title">ETS</h3>
                                {/* <!-- /.category-title --> */}
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="category-one__item">
                            ...
                            >
                              <div className="category-one__thumb">
                                <img
                                  decoding="async"
                                  src="/images/category-normal-3.png"
                                  alt="category-normal-3"
                                  title="category-normal-3"
                                />
                              </div>
                              {/* <!-- /.category-thumb --> */}
                              <div className="category-one__content">
                                ...
                                {/* <!-- /.category-icon --> */}
                                <h3 className="category-one__title">WAEC</h3>
                                {/* <!-- /.category-title --> */}
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="category-one__item">
                            ...
                            >
                              ...
                              <div className="category-one__content">
                                ...
                                {/* <!-- /.category-icon --> */}
                                <h3 className="category-one__title">JAMB</h3>
                                {/* <!-- /.category-title --> */}
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="category-one__item">
                            ...
                            >
                              ...
                              <div className="category-one__content">
                                ...
                                {/* <!-- /.category-icon --> */}
                                <h3 className="category-one__title">IELTS</h3>
                                {/* <!-- /.category-title --> */}
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="category-one__item">
                            ...
                            >
                              ...
                              <div className="category-one__content">
                                ...
                                {/* <!-- /.category-icon --> */}
                                <h3 className="category-one__title">GCE</h3>
                                {/* <!-- /.category-title --> */}
                              </div>
                            </div>
                          </div>
...
export default MultipleExamPlatform;
