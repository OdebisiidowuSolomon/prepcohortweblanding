...
import { DownloadMobileVersionButtons } from "./components";
            ...
            <div className="elementor-widget-wrap elementor-element-populated">
              ...
              >
                <div className="elementor-widget-container">
                  {/* <!-- About Start --> */}
                  <section className="bg-[#FBF9F9] about-one now">
                        ...
                        <div className="col-xl-6">
                          ...
                          >
                            ...
                            >
                              ...
                              <img
                                decoding="async"
                                // src="/images/Group10637.png"
                                src="/images/female-hand-holding-iPhone.png"
                                alt="alt"
                                title="about-1-1"
                              />
                            </div>
                          ...
                          <div className="about-one__content">
                            ...
                            <div className="section-title">
                              <h5
                                ...
                                style={{ padding: "0px", color: "#31265A" }}
                              >
                            ...
                            <p
                              ...
                              style={{ width: "80%" }}
                            >
                              To download the mobile version of Prepcohort,
...
export default DownloadMobileVersion;
