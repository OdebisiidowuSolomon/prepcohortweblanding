    ...
    <div className="col-xl-6">
      <div className="about-one__content">
        ...
        <p className="about-one__content__text">
          Explore some of our outstanding features designed to make you excel
        </p>
        <div className="about-one__box">
          <div className="about-one__box__wrapper">
            <div className="about-one__box__icon icon-svg-large">
              <span aria-hidden="true" className="fa fa-question-circle"></span>
            </div>
            <h4 className="about-one__box__title">Question and Answer</h4>
            <p className="about-one__box__text">
              You can ask questions and get relevant answers from your
              colleague, fostering interactive learning.
            </p>
          </div>
        </div>
        {/* <!-- /.icon-box --> */}
        <div className="about-one__box">
          <div className="about-one__box__wrapper">
            <div className="about-one__box__icon icon-svg-large">
              <span aria-hidden="true" className="fa fa-bullhorn"></span>
            </div>
            <h4 className="about-one__box__title">Scoped Announcement</h4>
            <p className="about-one__box__text">
              You can receive messages disseminated by instructor on any
              updated, news, or events. School-wide or class-wide
            </p>
          </div>
        </div>
        {/* <!-- /.icon-box --> */}
        <div className="about-one__box">
          <div className="about-one__box__wrapper">
            <div className="about-one__box__icon icon-svg-large">
              <span aria-hidden="true" className="fa fa-poll-h"></span>
            </div>
            <h4 className="about-one__box__title">Integrated Forms</h4>
            <p className="about-one__box__text">
              Information can be collected using form feature to gather data,
              facilitate surveys or manage various processes like registration
        ...
        <div className="about-one__box">
          <div className="about-one__box__wrapper">
            <div className="about-one__box__icon icon-svg-large">
              <span aria-hidden="true" className="fa fa-poll"></span>
            </div>
            <h4 className="about-one__box__title">Integrated Polls</h4>
            <p className="about-one__box__text">
              Polls are online votes where you can share your opinions on
              different topics. They enable you to tell others your take on
              cases.
            </p>
          </div>
        </div>
      ...
      Discover More<i className="icon-arrow"></i> </a
    > --> */}
        {/* <!-- /.btn --> */}
      </div>
      {/* <!-- about content end--> */}
