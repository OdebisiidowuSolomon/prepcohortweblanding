...
import { QuestionBankItem, questionBankData } from "./components";
import Helmet from "react-helmet";
import { SearchEngineResult, SearchItemType } from "../../../../intefaces";

type SearchEngineQuestionBank = Pick<SearchEngineResult, "questionBank">;

function QuestionBankSlider() {
  ...
  const [searchEngineQuestionBank, setSearchEngineQuestionBank] =
    useState<SearchEngineQuestionBank | null>(null);
  ...
  const handleSubmit = useCallback(async () => {
    searchFilter.reset();
    searchFilter.addToSearchItems(SearchItemType.QUESTION_BANK);
    ...
    try {
      ...
      const res: SearchEngineQuestionBank = data.searchEngine;
  ...
  '
                        >
                          ...
                          {searchEngineQuestionBank.questionBank.tests.map(
                            (item) => (
                              <QuestionBankItem
        ...
        <Helmet>
          ...
          <script
            defer={true}
            src="/js/tutor-front.min.js"
            id="tutor-frontend-js"
          ></script>
          <script
            defer={true}
...
export default QuestionBankSlider;
